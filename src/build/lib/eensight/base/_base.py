# -*- coding: utf-8 -*-
# License: BSD
# From scikit-learn to avoid dependence on private classes
...
class BaseHeterogeneousEnsemble(
    MetaEstimatorMixin, _BaseComposition, metaclass=ABCMeta
):
    """Base class for heterogeneous ensemble of learners.
    Adapted from sklearn.ensemble._base._BaseHeterogeneousEnsemble  v0.24.0
